...
parser = argparse.ArgumentParser(description="Compare ML methods on Feature set 1")
...
method.input_data = method.input_data[:,:4]
...
json.dump(dictionary, open(os.path.join(directory_path, "ML_performance.json"), "w"), cls=NumpyEncoder, indent=4)