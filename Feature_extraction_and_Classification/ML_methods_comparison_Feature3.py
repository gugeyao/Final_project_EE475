...
parser = argparse.ArgumentParser(description="Compare ML methods on Feature set 3")
...
method.input_data = method.data[:,-3:]
...
json.dump(dictionary, open(os.path.join(directory_path, "ML_performance_early_trends.json"), "w"), cls=NumpyEncoder, indent=4)